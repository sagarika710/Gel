...
<head>
  ...
  <title>Galileo Life || Admin | Pricing</title>
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card-header">            
            <h5 class="card-title mb-2">Pricing Section</h5>
          </div>
          <div class="card-body">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-lg"> Add Content </button>
          </div>
        </div>
        </div>
        <!-- slider data table -->
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pricing DataTable</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="price-table" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Serial No</th>
                    <th>Types</th>
                  ...
                  <?php
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo '<tr>
                                ...
                                <td><button type="button" class="btn btn-primary edit" id="'.$row['id'].'">Edit</button></td>
                                <td><button type="button" class="btn btn-danger delete" id="d'.$row['id'].'">Delete</button></td>
                            </tr>';
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Pricing section</h4>
            ...
            <div class="modal-body">
               <!-- form start -->
               <form id="quickForm" method="POST" action="./../DB_process/pricing_process.php?oper=insert-price">
                <div class="card-body">
                  <div class="form-group">
                    <label for="treatment">Add type</label>
                    <input type="hidden" name="hidId" id="hidId">
                    <input type="text" name="treatment" class="form-control" id="treatment" placeholder="Enter Type of treatment">
                  </div>
                  <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" id="btn-add" name="price-btn" class="btn btn-primary">Save changes</button>
            </div>
...
<script>
  $(document).ready( function () {
    ...
    var id =document.getElementById('hidId');
    id.value = "";
...
<script>
  $("#price-table tbody").on("click", ".edit", function(e){
  ...
  //     element.addEventListener('click', (e)=> {
      ...
      //  console.log(e.target.id);
       treatment.value = tr.getElementsByTagName('td')[1].innerHTML;
       desc.value = tr.getElementsByTagName('td')[2].innerHTML;
       price.value = tr.getElementsByTagName('td')[3].innerHTML;
        // console.log(id,treatment,desc,price);
  ...
  $("#price-table tbody").on("click", ".delete", function(e){
  ...
  //     element.addEventListener('click', (e)=> {
       ...
       if(confirm("Are you sure you want to delete this record?")){
        ...
        window.location = "./../DB_process/pricing_process.php?oper=delete-price&id="+id.value;
       }
